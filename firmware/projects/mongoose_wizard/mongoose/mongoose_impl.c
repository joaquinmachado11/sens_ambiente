...
struct attribute s_nox_attributes[] = {
  {"nox_index", "double", NULL, offsetof(struct nox, nox_index), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_pm_attributes[] = {
  {"mass_concentration_pm1p0", "double", NULL, offsetof(struct pm, mass_concentration_pm1p0), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_co2_attributes[] = {
  {"co2_concentration", "double", NULL, offsetof(struct co2, co2_concentration), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_voc_attributes[] = {
  {"voc_index", "double", NULL, offsetof(struct voc, voc_index), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_humidity_attributes[] = {
  {"relative_humidity", "double", NULL, offsetof(struct humidity, relative_humidity), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_temperature_attributes[] = {
  {"temperature", "double", NULL, offsetof(struct temperature, temperature), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
...
struct apihandler_data s_apihandler_nox = {{"nox", "data", true, 0, 0, 0UL}, s_nox_attributes, sizeof(struct nox), (void (*)(void *)) glue_get_nox, NULL};
struct apihandler_data s_apihandler_pm = {{"pm", "data", true, 0, 0, 0UL}, s_pm_attributes, sizeof(struct pm), (void (*)(void *)) glue_get_pm, NULL};
struct apihandler_data s_apihandler_co2 = {{"co2", "data", true, 0, 0, 0UL}, s_co2_attributes, sizeof(struct co2), (void (*)(void *)) glue_get_co2, NULL};
struct apihandler_data s_apihandler_voc = {{"voc", "data", true, 0, 0, 0UL}, s_voc_attributes, sizeof(struct voc), (void (*)(void *)) glue_get_voc, NULL};
struct apihandler_data s_apihandler_humidity = {{"humidity", "data", true, 0, 0, 0UL}, s_humidity_attributes, sizeof(struct humidity), (void (*)(void *)) glue_get_humidity, NULL};
struct apihandler_data s_apihandler_temperature = {{"temperature", "data", true, 0, 0, 0UL}, s_temperature_attributes, sizeof(struct temperature), (void (*)(void *)) glue_get_temperature, NULL};
...
static struct apihandler *s_apihandlers[] = {
  (struct apihandler *) &s_apihandler_nox,
  (struct apihandler *) &s_apihandler_pm,
  (struct apihandler *) &s_apihandler_co2,
  (struct apihandler *) &s_apihandler_voc,
  (struct apihandler *) &s_apihandler_humidity,
  (struct apihandler *) &s_apihandler_temperature,
