...
static struct nox s_nox = {0.8};
void glue_get_nox(struct nox *data) {
  *data = s_nox;  // Sync with your device
}

static struct pm s_pm = {10};
void glue_get_pm(struct pm *data) {
  *data = s_pm;  // Sync with your device
}

static struct co2 s_co2 = {4000};
void glue_get_co2(struct co2 *data) {
  *data = s_co2;  // Sync with your device
}

static struct voc s_voc = {60};
void glue_get_voc(struct voc *data) {
  *data = s_voc;  // Sync with your device
}

static struct humidity s_humidity = {25};
void glue_get_humidity(struct humidity *data) {
  *data = s_humidity;  // Sync with your device
}

static struct temperature s_temperature = {35};
